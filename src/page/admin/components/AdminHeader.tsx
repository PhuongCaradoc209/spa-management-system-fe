  ...
  return (
    <header className="fixed top-0 w-full z-50 flex items-center justify-between px-8 py-6 bg-surface/70 backdrop-blur-xl shadow-[0_8px_32px_rgba(62,102,88,0.05)] border-b border-outline-variant/30">
      <div className="flex items-center gap-4">
        ...
        <div>
          <p className="text-xs font-label tracking-widest uppercase text-on-surface-variant/60">Administrator</p>
          <h1 className="text-xl font-headline font-semibold tracking-widest uppercase text-primary dark:text-emerald-50">Lumière Wellness</h1>
        </div>
      </div>
      <div className="flex items-center gap-6">
        <div className="hidden md:flex gap-8 items-center text-on-surface-variant/60">
          <a className="text-primary font-medium transition-opacity duration-500 hover:opacity-80" href="#">Overview</a>
          <a className="transition-opacity duration-500 hover:opacity-80" href="#">Services</a>
          <a className="transition-opacity duration-500 hover:opacity-80" href="#">Inventory</a>
          <a className="transition-opacity duration-500 hover:opacity-80" href="#">Staff</a>
        </div>
        <AppButton variant="ghost" size="sm" iconLeft="add_circle" className="p-2 min-w-0" />
      </div>
    </header>
  );
};
